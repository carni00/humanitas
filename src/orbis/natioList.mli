...
val update   : G.Natio.t Nid.Nil.t -> Junctiones.Natio.t Nid.Nil.t -> CivitasList.t -> t -> Partitio.Record.t Nid.Nil.t -> Lucrum.t -> Partitio.t Nid.Nil.t -> (Ars.cognitio * Ars.t) list Nid.Nil.t -> t
